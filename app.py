...
if "task_schedule" not in st.session_state:
    init_tasks = [
        ...
        {"ชื่อพนักงาน": "เมธา (Jack)", "ทีม": "Center Engineer", "กะ": "Day", "ประเภท": "แผนงาน", "Status": "R&D", "หมวดหมู่": "Others", "ชื่องาน": "Silent Cinema", "รายละเอียด": "Find Solution and Product", "เริ่ม": "2026-05-11 09:00", "สิ้นสุด": "2026-05-29 18:00"},
